...
xstart(:,1)  = [ 0; 0; 0; -10 ];            tbirth(1)  = 1;     tdeath(1)  = 50;
xstart(:,2)  = [ -200; -3; 800; -15 ];      tbirth(2)  = 1;     tdeath(2)  = truth.K+1;
xstart(:,3)  = [ -800; 20; -200; -5 ];      tbirth(3)  = 1;     tdeath(3)  = 50;

xstart(:,4)  = [ 400; -7; -600; -4 ];       tbirth(4)  = 20;    tdeath(4)  = 70;
xstart(:,5)  = [ 400; -2.5; -600; 10 ];     tbirth(5)  = 20;    tdeath(5)  = truth.K+1;
xstart(:,6)  = [ 400; -10; -600; 5 ];       tbirth(6)  = 20;    tdeath(6)  = 70;

xstart(:,7)  = [ -200; 15; 800; -5 ];       tbirth(7)  = 40;    tdeath(7)  = truth.K+1;
xstart(:,8)  = [ -200; 15; 800; -10 ];      tbirth(8)  = 40;    tdeath(8)  = truth.K+1;

xstart(:,9)  = [ -800; 3; -200; 15 ];       tbirth(9)   = 60;   tdeath(9)  = truth.K+1;
xstart(:,10)  = [ 0; 7.5; 0; -5 ];          tbirth(10)  = 60;   tdeath(10) = truth.K+1;

xstart(:,11)  = [ 0; -20; 0; -15 ];         tbirth(11)  = 80;   tdeath(11) = truth.K+1;
xstart(:,12)  = [ -800; 12; -200; 7 ];      tbirth(12)  = 80;   tdeath(12) = truth.K+1;
